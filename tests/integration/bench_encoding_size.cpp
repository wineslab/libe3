 ...
 * the message id INTEGER (1..1000) -> 10 bits, the 11-way PDU CHOICE index
 * -> 4 bits), in their minimal bit width with no per-field tags, so e.g.
 * SubscriptionDelete measures 5 wire bytes against 12 info bytes. Text
