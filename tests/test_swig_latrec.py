...
def main():
    ...
    os.environ["LATREC_DIR"] = trace
    os.environ["LATREC_ENTRIES_LOG2"] = "16"
    # Import only after LATREC_DIR is set: rings are opened from it on demand.
    try:
        import libe3py
    ...
    try:
        ...
        ran = subprocess.Popen(
            ...
            env={**os.environ, "LATREC_DIR": trace})
        ...
        os.environ.pop("LATREC_DIR", None)
